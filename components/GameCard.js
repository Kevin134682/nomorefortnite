  ...
  return html`
    ...
    >
      <div className="relative h-48 overflow-hidden">
        ...
        />
        ${game.isHot && html`
          <div className="absolute top-2 left-2 px-2 py-1 bg-gradient-to-r from-red-600 to-orange-500 text-[10px] font-bold uppercase rounded-md tracking-wider shadow-lg text-white">
            Hot
          </div>
        `}
